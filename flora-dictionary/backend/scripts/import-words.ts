...
const WORDS: string[] = [
  ...
  'build','business','brain','brave','beach','beauty','begin','bread','breath',
  ...
  'doubt','drama','drink','dress','dozen','daily','danger','defend','depend',
  ...
  'earn','eat','east','election','emotion','enough','escape','evil',
  ...
  'great','green','ground','grow','guess','guide','guilt','grace','grand',
